...
#PBS -o /mnt/lustre/users/fkebaso/projects/hippo/long_reads/run_2/hcamelina_male/results/braker/galaxy_masked_softmasking_off_restart/braker.out
#PBS -e /mnt/lustre/users/fkebaso/projects/hippo/long_reads/run_2/hcamelina_male/results/braker/galaxy_masked_softmasking_off_restart/braker.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N braker_masked_off_restart
