...
basedir="/nfs/fkebaso/projects/hippo/long_reads/hcamelina_female/results/orthofinder"
ortho_files="${basedir}/hpc02_analysis_outputs_2"

# Specify the input files
orthogroups_txt=${ortho_files}/Results_May31/Orthogroups/Orthogroups.txt
orthogroup_Seqs=${ortho_files}/Results_May31/Orthogroup_Sequences
protein_file=${ortho_files}/proteindb #Dir to Files used to run orthofinder 

codingseq=${basedir}/post_orthofiles/hcamelina_female.codingseq
ann_file=${basedir}/post_orthofiles/hcamelina_female.braker.gtf
genome_file=${basedir}/orthofinder/post_orthofiles/hcamelina_female_genome.fa
predicted_genes=${basedir}/orthofinder/post_orthofiles/hcamelina_female.fasta
predicted_species_name="hcamelina_female_fcs"
gene_group="chemosensory_genes"
combined_gene_file="all_predicted_chemosensory_genes.fa"
gene_rename_pattern="hcf_"
