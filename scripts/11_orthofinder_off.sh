...
#PBS -o /home/fkebaso/lustre/projects/hippo/long_reads/run_2/hcamelina_male/results/orthofinder/galaxy_softmasked_off/orthofinder.out
#PBS -e /home/fkebaso/lustre/projects/hippo/long_reads/run_2/hcamelina_male/results/orthofinder/galaxy_softmasked_off/orthofinder.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N orthofinder_hcm-f_off
...
basedir="/nfs/fkebaso/projects/hippo/long_reads/run_2/hcamelina_male/results/orthofinder/galaxy_softmasked_off"
prot_sequences="${basedir}/proteindb"
results="${basedir}/analysis_outputs_off"
threads=62
