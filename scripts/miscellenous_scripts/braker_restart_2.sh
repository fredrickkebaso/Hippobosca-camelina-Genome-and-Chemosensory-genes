...
#PBS -o /mnt/lustre/users/fkebaso/hippo/long_reads/hcamelina_female/results/braker/fcs_cleaned_restart/braker.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/long_reads/hcamelina_female/results/braker/fcs_cleaned_restart/braker.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N braker_fcs_restart
...
basedir="/mnt/lustre/users/fkebaso/hippo/long_reads/hcamelina_female"
threads=48
# Set the working directory for the new run
new_work_dir="${basedir}/results/braker/fcs_cleaned_restart"

# Set the directory for the previous run
oldDir="${basedir}/results/braker/fcs_cleaned"
